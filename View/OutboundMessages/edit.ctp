...
<?php echo $this->Form->create('OutboundMessage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Outbound Message'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OutboundMessage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('OutboundMessage.id'))); ?></li>
